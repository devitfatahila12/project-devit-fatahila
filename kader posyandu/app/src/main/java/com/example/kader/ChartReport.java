...
public class ChartReport extends AppCompatActivity {
    ...
    AutoCompleteTextView jenis_peserta;
    BarChart chart;
    Button submitButton;
    loading mLoading;
    TextView text_hasil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jenis_peserta = (AutoCompleteTextView) findViewById(R.id.jenis_peserta);
        ArrayList<String> jkp = getDataSpinner();
        ArrayAdapter<String> adapter = new ArrayAdapter<>(ChartReport.this, android.R.layout.simple_spinner_item, jkp);
        jenis_peserta.setAdapter(adapter);
        jenis_peserta.addTextChangedListener(watcher);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(jenis_peserta.getText().toString().equals("Balita")){
                    doGraphBalita();
                } else if(jenis_peserta.getText().toString().equals("Ibu Hamil")){
                    doGraphIbuHamil();
                } else {
                    doGraphLansia();
                }
...
//                                barDataSetTensiDarah.setValueTextSize(16f);
    ...
    public ArrayList<String> getDataSpinner(){
        ArrayList<String> jenis_kepesertaan = new ArrayList<>();
        jenis_kepesertaan.add("Balita");
        jenis_kepesertaan.add("Ibu Hamil");
        jenis_kepesertaan.add("Lansia");
        return jenis_kepesertaan;
    }
    ...
    private final TextWatcher watcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            if (nik.getText().toString().length() == 0 ||
                    jenis_peserta.getText().toString().length() == 0 ) {
                submitButton.setEnabled(false);
            } else {
